...
//本程序用于把Tipask V1.4Beta 升级到V1.4正式版
...
EOT;
if(!$action) {
	echo"本程序仅用于升级 Tipask V1.4beta 到 Tipask1.4正式版,请确认之前已经顺利安装Tipask V1.4beta!<br><br><br>";
	echo"<b><font color=\"red\">运行本升级程序之前,请确认已经上传 Tipask1.4正式版的全部文件和目录</font></b><br><br>";
	echo"<b><font color=\"red\">本程序只能从 Tipask V1.4beta 到 Tipask1.4正式版,切勿使用本程序从其他版本升级,否则可能会破坏掉数据库资料.<br><br>强烈建议您升级之前备份数据库资料!</font></b><br><br>";
	echo"正确的升级方法为:<br>1. 上传 Tipask1.4 正式版的全部文件和目录,覆盖服务器上的 Tipask v1.4beta版;<br>2. 上传本程序(1.4betaTo1.4.php)到 Tipask目录中;<br>3. 运行本程序,直到出现升级完成的提示;<br>4. 登录Tipask后台,更新缓存,升级完成。<br><br>";
