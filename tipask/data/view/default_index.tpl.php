<? if(!defined('IN_TIPASK')) exit('Access Denied'); include template('header'); $adlist = $this->fromcache("adlist"); $statistics=$this->fromcache('statistics'); $onlineusernum=$this->fromcache('onlineusernum'); ?><div class="nav-line">
    <div class="count_info">
        <span class="icon_count"/></span><span>已解决问题：<?=$statistics['solves']?></span><span>待解决问题：<?=$statistics['nosolves']?></span><span>当前在线：<? if($this->user['grouptype']==1) { ?><a href="<?=SITE_URL?>?index/online.html"><?=$onlineusernum?></a><? } else { ?>1<?=$onlineusernum?><? } ?>人</span>
    </div>
<div id="scoll-note">
    <ul>
...
<? } } ?>
            ...
            <div class="modbox mt10">
                ...
                <div class="portal_block_summary"><table border="0" id="table1" cellspacing="4" cellpadding="3">
                    <tbody><tr>
                        <td align="center">
                            <img border="0" src="http://mh.weizy.cn/pic/2wm-weizy.jpg" alt="微中医微信" width="100" height="100"></td>
                        <td align="center">
                            <p align="left">微信号：hiweizy<br>
                                公众号：微中医<br>
                                扫描即可，欢迎关注<br>
                                用10年时间专注于中医<br>
                                让1000万家庭更健康</p></td>
